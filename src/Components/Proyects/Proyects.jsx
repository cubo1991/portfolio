...
<div id="carouselExampleCaptions" className="carousel slide carousel-fade" data-bs-ride="carousel" >
  ...
  <div className="carousel-inner">
    ...
    <iframe width="560" height="220" className="d-block w-100" src="https://www.youtube.com/embed/5FqolQbA9dw?rel=0?version=3&mute=1&autoplay=1&loop=1&controls=0&playlist=5FqolQbA9dw" title="YouTube video player" frameBorder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
    ...
    <iframe width="560" height="220"  className="d-block w-100" src="https://www.youtube.com/embed/UpU9lYdXyYM?rel=0?version=3&mute=1&autoplay=1&loop=1&controls=0&playlist=UpU9lYdXyYM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item">
    <iframe width="560" height="220" className="d-block w-100" src="https://www.youtube.com/embed/1_5Zig2uc1Q?rel=0?version=3&mute=1&autoplay=1&loop=1&controls=0&playlist=1_5Zig2uc1Q" title="YouTube video player" frameBorder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
      <div className="carousel-caption d-none d-md-block">
